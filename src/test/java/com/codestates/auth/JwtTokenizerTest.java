...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // 클래스 단위 생명주기를 가진다.
public class JwtTokenizerTest {
    ...
    // (1)
    @BeforeAll // 초기화 한번만 실행
    public void init() {
        jwtTokenizer = new JwtTokenizer();
        secretKey = "subin1234123412341234123412341234";

        base64EncodedSecretKey = jwtTokenizer.encodeBase64EscretKey(secretKey);
    }
